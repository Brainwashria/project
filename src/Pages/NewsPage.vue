<template>
	<div id="newsPage">
		...
		<button v-if="returnUserType === 'user'" @click="openRecordsPopup" id="addNews">Добавить новость</button>
		<RecordAddingPopup v-if="isPopupShowing" @close-records-popup="closeRecordsPopup"/>
