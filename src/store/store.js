...
export default new Vuex.Store({
  actions: {
    setTheUserAction({commit}, payload) {
      commit('setTheUser', payload)
    },
    addTheNewsAction({commit}, payload) {
      commit('addTheNews', payload);
    },
    addTheApprovalAction({commit}, payload) {
      commit('AddTheApproval', payload)
    },
    deleteTheNewsAction({commit}, payload) {
      commit('deleteTheNews', payload);
    }
  },
  mutations: {
    setTheUser(state, payload) {
      state.userType = payload.userType;
      state.username = payload.username;
    },
    addTheNews(state, payload) {
